...
def main():
    # loading sampled amazon health dataset
    dataframe_arrow = load_from_disk("datasets/amazon_health_reviews_10k")
    dataframe = dataframe_arrow.to_pandas()
    dataframe.to_csv("datasets/csvs/amazon_health.csv", index=False)
    ...
    # data checks for my own sanity (remove raw text and raw timestamp as i have info i need)
    ...
    # save outputs
    output_path = "datasets/processed/amazon_health_features.csv"
