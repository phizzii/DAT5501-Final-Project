...
dataset_stream = load_dataset("json", data_files="hf://datasets/McAuley-Lab/Amazon-Reviews-2023/raw/review_categories/Beauty_and_Personal_Care.jsonl", split="train", streaming=True)
...
dataset.save_to_disk("datasets/amazon_beauty_reviews_10k")